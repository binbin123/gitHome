...
public class DesUtils
{
  ...
  public static final String[] video_extensions = {".3gp", ".divx", ".h264", ".avi", ".m2ts", ".mkv", ".mov", ".mp2", ".mp4", ".mpg", ".mpeg", ".rm", ".rmvb", ".wmv", ".ts", ".tp", ".dat", ".vob", ".flv", ".vc1", ".m4v", ".f4v", ".asf", ".lst", ".m2v", ".mts", ".3g2", ".dv", ".trp" };
  private Cipher decryptCipher = null;
  private Cipher encryptCipher = null;

  static
  {
    music_extensions = new String[] { ".amr",".mp3", ".wma", ".m4a", ".aac", ".ape", ".ogg", ".flac", ".alac", ".wav", ".mid", ".xmf", ".mka", ".pcm", ".adpcm", ".ac3" };
    photo_extensions = new String[] { ".jpg", ".jpeg", ".bmp", ".tif", ".tiff", ".png", ".gif", ".giff", ".jfi", ".jpe", ".jif", ".jfif", ".jps" };
  }
...
public static String getFileName(String pathandname){
    ...
    if (start!=-1 && end!=-1) {
      try{
        return URLDecoder.decode(pathandname.substring(start+1, end), "UTF-8");
  ...
  public static String GetCpuInfo(DesUtils paramDesUtils)
  {
    ...
    try
    {
      localObject = localCommandRun.run(new String[] { "/system/bin/cat", "/proc/cpuinfo" }, "/system/bin/");
  ...
  public static boolean isAmlogicChip()
  {
    try
    {
      ...
      int i = localDesUtils.decrypt(GetCpuInfo(localDesUtils)).indexOf(localDesUtils.decrypt("7c0f13b6d5986e65"));
      int j = 0;
      if (i != -1)
        j = 1;
  ...
  public static String pathTransferForJB(String paramString)
  {
    ...
    if (paramString.startsWith("/storage/sd"))
    {
      if (paramString.contains("/storage/sdcard0"))
        str = paramString.replaceFirst("/storage/sdcard0", "/mnt/sdcard");
      else
