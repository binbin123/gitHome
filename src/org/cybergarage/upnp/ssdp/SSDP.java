...
public class SSDP
{
	...
	public static final int BCPORT = 8008;
	public static final int DATAPORT = 9900;
	/**
	...
	public static final int RECV_MESSAGE_BUFSIZE = 1024*2; //shixq modify from 1024 to 2048
