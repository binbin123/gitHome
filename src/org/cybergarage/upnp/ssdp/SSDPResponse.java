...
public class SSDPResponse extends HTTPResponse
{
	...
	{
		setHeader(HTTP.FRIENDNAME, value);
	}

	 public void setCONTROLURL(String value)
	  {
	  // Debug.d("DMRService", "setCONTROLURL =  " + value);
	    setHeader(HTTP.CONTROLURL, value);
	  }
	 
	  public void setEVENTURL(String value)
	  {
	   // Debug.d("DMRService", "setEVENTURL =  " + value);
	    setHeader(HTTP.EVENTURL, value);
	  }
//	  public void setSEARCHDEVICE(String value)
//	  {
//	
//	    setHeader(HTTP.SEARCHDEVICE, value);
//	  }
	public String getMYNAME()
	{
		return getHeaderValue(HTTP.FRIENDNAME);
	}
