...
public class Service
{
	...
	public boolean loadSCPD(File file) throws ParserException
	{
		...
		if (scpdNode == null)
			return false;
		ServiceData data = getServiceData();
		//Log.d("shixq","data value = " + data.getNode().getValue());
		data.setSCPDNode(scpdNode);
		return true;
	}
	...
	public byte[] getSCPDData()
	{
		...
		Log.d("cryber","scpdNode  = " + scpdNode.getValue());
	...
	public ServiceStateTable getServiceStateTable()
	{
		...
		/*---------add by shixq 20130409 begin*/
		Node scpdNode = getSCPDNode();
		if(scpdNode == null)
		  return stateTable;
		/*---------add by shixq 20130409 end*/
