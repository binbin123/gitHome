...
public class HTTPPacket 
{
	...
	{	
	  ...
	  {
	    setHeader("User-Agent", paramString);
	  }
	  public void setAccept(String paramString)
	  {
	    setHeader("Accept", paramString);
	  }
	  public void setReferer(String paramString)
	  {
	    setHeader("Referer", paramString);
	  }
	  public void setProxyConnection(String paramString)
	  {
	    setHeader("Proxy-Connection", paramString);
	  }
	////////////////////////////////////////////////
	//	set
	////////////////////////////////////////////////
